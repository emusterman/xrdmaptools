...
class XRDBaseScan(XRDData):
    ...
    xrddatakwargs : keyword arguments, optional 
        All other kwargs for parent XRDData class.
    ...
    def from_hdf(cls,
        ...
        kwargs : keyword arguments, optional
            Keyword arguments passed to instantiate the class. These
            should not overlap with other keyword arguments read from
            the HDF file.
    ...
    def from_image_stack(cls,
        ...
        dask_enabled : bool, optional
            ...
            loaded as a Dask array. Default is False.
        kwargs : keyword arguments, optional
            Keyword arguments passed to instantiate the class.
    ...
    def _trim_spots(spots,
                    ...
                    key='height'):
        """
        Internal function for trimming pandas dataframes of XRD spots.

        All spots with a certain key value below a given threshold will
        be removed.
        
        This function defines universal behavior of other externally
        facing trim_spots functions.

        Parameters
        ----------
        spots : Pandas Dataframe
            Pandas Dataframe of XRD spots generated by a find_spots
            type function.
    ...
    def _title_with_scan_id(self,
                            ...
                            title_scan_id=True):
        """
        Internal function for prepending plot titles with the data scan
        ID.
    ...
    def plot_image(self,
        ...
        Image plotting function for a given image, a given indices for
        an image in the data, or a random image from the data if no
        image or indices is specified.

        Parameters
        ----------
        image : 2D Numpy.ndarray, optional
            Image data to be plotted. Must be a 2D Numpy array, but
            does not have to match the image shape. None by default and
            the function will attempt to plot an image from the data.
        indices : iterable of length 2, optional
            Indices of structure [map_y, map_x] used to plot an image
            from the data. If the image parameter is passed explicitly,
            indices will not be used. None by default.
        title : str, optional
            Title of the image. By default, a title will be generated
            based on the image and indices parameters.
        mask : bool, optional
            Flag to determine if masked data should be excluded. If no
            mask has been defined, all data within an image will be
            plotted. False by default.
        spots : bool, optional
            Flag to determine if spots will be plotted. If spots have
            not already been found, not spots will be plotted. False by
            default.
        contours : bool, optional
            Flag to determine if contours will be plotted around blobs.
            If blobs have not already been, no contours will be
            plotted. False by default.
        ...
        aspect : str, optional
            Aspect ratio of plot passed to axes.set_aspect function.
            'auto' by default.
        title_scan_id : bool, optional
        ...
        KeyError if indices are not None and are not within the map
        shape.
        AttributeError if no image is given and there are no images in
        the instance.
        """
